...
security_txt! {
     ...
     policy: "https://github.com/MyDonutProject/donut-matrix-system/blob/main/SECURITY.md",
     preferred_languages: "en",
     source_code: "https://github.com/MyDonutProject/donut-matrix-system/blob/main/programs/matrix-system/src/lib.rs",
